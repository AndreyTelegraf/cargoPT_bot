...
def main() -> None:
    with TestClient(app) as client:
        checks = [
            ...
            ("/", "/assets/js/landing.js?v=acquisition-funnel-v1-idempotency-v1"),
            ("/en/", "/assets/js/landing.js?v=acquisition-funnel-v1-idempotency-v1"),
            ("/ru/", "/assets/js/landing.js?v=acquisition-funnel-v1-idempotency-v1"),
