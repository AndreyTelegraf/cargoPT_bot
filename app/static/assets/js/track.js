...
const MESSAGE_SETS = {
  ...
  en: {
    ...
    offerTermsLabel: "Offer terms",
    includedServicesLabel: "Included services",
    possibleSurchargesLabel: "Possible extras",
    serviceWindowLabel: "Service date / time window",
    estimateStatusLabel: "Price type",
    estimateFinalLabel: "Final",
    estimateEstimateLabel: "Estimate",
  ...
  ru: {
    ...
    offerTermsLabel: "Условия предложения",
    includedServicesLabel: "Что включено",
    possibleSurchargesLabel: "Возможные доплаты",
    serviceWindowLabel: "Дата / временное окно",
    estimateStatusLabel: "Тип цены",
    estimateFinalLabel: "Окончательная",
    estimateEstimateLabel: "Предварительная",
