...
async def _transition_job_status(
    ...
    *,
    ...
    return await service.repository.update_job_status(
        job_id=job_id,
...
async def start_job(service: JobService, *, job_id: int) -> Job:
...
async def complete_job(service: JobService, *, job_id: int) -> Job:
    return await _transition_job_status(
        service,
        job_id=job_id,
